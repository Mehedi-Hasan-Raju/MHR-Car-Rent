...
import stepsCarImg from "../assets/steps-car.avif";
  ...
  return (
    <section className="py-24">
      <div className="mx-auto max-w-6xl px-6">
        ...
        <div className="mt-14 grid grid-cols-2 gap-6 rounded-[22px] bg-ink p-9 text-white sm:grid-cols-4">
          <div>
